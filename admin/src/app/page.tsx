    ...
    <div style={{ minHeight: "100vh", background: "#060B1A", color: "#F3F4F6", display: "flex" }}>
      ...
      {selectedLead && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", backdropFilter: "blur(10px)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
          <div style={{ background: "#0B1224", border: "1px solid rgba(56, 189, 248, 0.3)", borderRadius: "20px", padding: "2.5rem", maxWidth: "800px", width: "100%", maxHeight: "90vh", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(255,255,255,0.08)", paddingBottom: "1rem" }}>
              <div>
                ...
                <div style={{ color: "#38BDF8", fontSize: "0.82rem", fontWeight: 700, marginTop: "0.2rem" }}>Lead ID: {selectedLead.id} · Score: {selectedLead.score}/100</div>
              </div>
