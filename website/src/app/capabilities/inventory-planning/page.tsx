    ...
    <div style={{ background: "#0B0F19", color: "#F3F4F6", minHeight: "100vh" }}>
      ...
      <section className="page-hero-wrapper">
        <div className="container" style={{ textAlign: "center", maxWidth: "800px" }}>
          <span className="diagnostic-step-pill">📊 Capability 03</span>
          ...
          <p className="hero-description" style={{ color: "#9CA3AF", fontSize: "1.1rem", marginTop: "1rem" }}>
            Channel-wise allocation across marketplaces, D2C, B2B/institutional, and dealer supplies to eliminate stock-outs and holding overage.
          </p>
